<template>
  <div class="vdp-datepicker" :class="[wrapperClass, isRtl ? 'rtl' : '']">
    ...
    >
      ...
      <slot name="tooltip-label" slot="tooltip-label" />
    </date-input>
    <button type="button" class="vdp-toggle" @click="showCalendar">
      <svg
        width="19px"
        height="19px"
        version="1.1"
      ...
      >
        <use xlink:href="../assets/calendar.svg#calendar-icon"></use>
      </svg>
    </button>
...
export default {
  ...
  methods: {
     ...
     * @return {mixed}
     */
    showCalendar(event, preventClose) {
      if (event) {
