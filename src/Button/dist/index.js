!(function (t, e) {
  ...
  (function (t) {
      ...
      (function (t, n) {
        ...
        function Et(t, e) {
          ...
          for (
            ...
            '__ob__' !== (n = i[a]) &&
              ((r = t[n]),
              (o = e[n]),
              b(t, n) ? r !== o && l(r) && l(o) && Et(r, o) : kt(t, n, o));
          return t;
        }
        function It(t, e, n) {
          return n
        ...
        function Ie(t, e, n, o, i) {
          ...
          (this.data = t),
            ...
            (this.slots = function () {
              return (
                c.$slots || ve(t.scopedSlots, (c.$slots = pe(n, o))), c.$slots
              );
            }),
              ...
              if (a(t.options.functional))
                return (function (t, e, n, o, a) {
                  ...
                  if (i(u)) for (var l in u) c[l] = Ft(l, u, e || r);
                    ...
                    i(n.attrs) && Me(c, n.attrs), i(n.props) && Me(c, n.props);
        ...
        function Xe(t, e, n) {
          (Be = t), ae(e, n || {}, We, Ke, qe, t), (Be = void 0);
        }
        var Ge = null;
        function Ze(t) {
          var e = Ge;
        ...
        function yn(t, e, n) {
          var r = !rt();
          'function' == typeof n
            ? ((dn.get = r ? gn(e) : _n(n)), (dn.set = E))
            : ((dn.get = n.get ? (r && !1 !== n.cache ? gn(e) : _n(n.get)) : E),
              (dn.set = n.set || E)),
            ...
            if (!k || w || '' === w) {
              ...
              var L = !1 !== a && !Z,
                ...
                R = (n._enterCb = N(function () {
                  L && (Jr(n, j), Jr(n, T)),
                    R.cancelled ? (L && Jr(n, S), M && M(n)) : P && P(n),
                    (n._enterCb = null);
                }));
              t.data.show ||
                ...
                L &&
                  ...
                  Gr(function () {
                    Jr(n, S),
                      R.cancelled ||
                        (Zr(n, j),
                        F || (io(D) ? setTimeout(R, D) : Qr(n, s, R)));
                  })),
          ...
          if (!i(n._leaveCb)) {
            ...
            var O = (n._leaveCb = N(function () {
              n.parentNode &&
                ...
                _ && (Jr(n, l), Jr(n, f)),
                O.cancelled ? (_ && Jr(n, u), m && m(n)) : (e(), v && v(n)),
                (n._leaveCb = null);
            }));
            y ? y(C) : C();
          }
            ...
            O.cancelled ||
              ...
              _ &&
                ...
                Gr(function () {
                  Jr(n, u),
                    O.cancelled ||
                      (Zr(n, l), b || (io(w) ? setTimeout(O, w) : Qr(n, s, O)));
                })),
              d && d(n, O),
              _ || b || O());
          }
                      ...
                      (function (t, e, n, r, a) {
                        ...
                        for (0; p <= v && d <= y; )
                          o(h)
                            ...
                            : er(m, g)
                            ? (A(m, g, r, n, d),
                              O && u.insertBefore(t, m.elm, h.elm),
                              (m = e[--v]),
                              (g = n[++d]))
                            : (o(s) && (s = nr(e, p, v)),
                              o((c = i(g.key) ? s[g.key] : C(g, e, p, v)))
                                ? f(g, r, t, h.elm, !1, n, d)
                                : er((l = e[c]), g)
                                ? (A(l, g, r, n, d),
                                  (e[c] = void 0),
                                  O && u.insertBefore(t, l.elm, h.elm))
                                : f(g, r, t, h.elm, !1, n, d),
                              (g = n[++d]));
                        p > v
        ...
        function fo(t, e, n) {
          ...
          if (!o || Array.isArray(r)) {
            for (var i, a, s = 0, c = t.options.length; s < c; s++)
              if (((a = t.options[s]), o))
                (i = D(r, vo(a)) > -1), a.selected !== i && (a.selected = i);
              else if (M(vo(a), r))
        ...
        (Cn.config.mustUseProp = function (t, e, n) {
          ...
          T(Cn.options.directives, _o),
          T(Cn.options.components, Eo),
          (Cn.prototype.__patch__ = W ? co : E),
    ...
    function (t, e, n) {
      ...
      var C = (() => {
        let t = class extends o.a {};
        return (
          r(
            [O({ type: String, default: 'primary' })],
            t.prototype,
            'theme',
            void 0
          ),
          r([O({ type: String, default: 'md' })], t.prototype, 'size', void 0),
          r(
            [O({ type: String, default: 'button' })],
            t.prototype,
            'as',
            void 0
          ),
          ...
          r([O({ type: Boolean, default: !1 })], t.prototype, 'block', void 0),
          (t = r([_], t)),
          t
        );
      })();
